...
--
-- Host: localhost
-- Generation Time: Apr 02, 2016 at 07:17 PM
...
CREATE TABLE `bal_ordered_product` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `bal_parent_notification` (
  ...
  `notification_type` enum('APPUN','APPAR','APPIN','APPADMRM','REDEEM','UNLOCK','TROPHY','WAGER','IMAGE','LOCK','WEEKLYGOAL','SENDCHALLENGE','PAIR','NEW_SUBJECT','REWARD') DEFAULT NULL COMMENT AS `APPUN => app uninstalled, APPAR => app admin removed`,
...
CREATE TABLE `bal_purchase_order` (
  `id` bigint(100) NOT NULL COMMENT 'This is Purchase order id ',
...
--
-- Indexes for table `bal_challan`
--
ALTER TABLE `bal_challan`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `bal_clients`
--
ALTER TABLE `bal_clients`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `bal_ordered_product`
--
ALTER TABLE `bal_ordered_product`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `bal_purchase_order`
--
ALTER TABLE `bal_purchase_order`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `bal_admin_users`
  MODIFY `admin_user_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `bal_challan`
--
ALTER TABLE `bal_challan`
  MODIFY `id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1009;
--
-- AUTO_INCREMENT for table `bal_clients`
--
ALTER TABLE `bal_clients`
...
--
-- AUTO_INCREMENT for table `bal_ordered_product`
--
ALTER TABLE `bal_ordered_product`
...
--
-- AUTO_INCREMENT for table `bal_products`
--
ALTER TABLE `bal_products`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `bal_purchase_order`
--
ALTER TABLE `bal_purchase_order`
  MODIFY `id` bigint(100) NOT NULL AUTO_INCREMENT COMMENT 'This is Purchase order id ', AUTO_INCREMENT=10009;
--
